            ...
            <div class="login-form">
                  ...
                  <div class="form-group">
                   <label>Features</label>
                     <input type="text"  class="form-control" name="features"  value="${item.features}" 
                  ...
                  <div class="form-group">
                   <label>Quantity Available</label>
                     <input type="text"  class="form-control" name="quantity_available"  value="${item.quantity_available}" 
